...
public interface TaxBurdenService {
	public List<PostalCodePoliticalDivision> findAllPoliticalDivisionsByPostalCode(String postalCode);
	public TaxBurdenReport createReport(TaxPayerProfile taxPayerProfile);
	public TaxPayerProfile createTaxPayerProfile(String postalCode, List<String> politicalDivisionKeys, MonetaryAmount annualIncome, MonetaryAmount mortgageInterest);
